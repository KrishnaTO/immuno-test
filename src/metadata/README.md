 ...
 * [immunotest.yml](immunotest.yml)
     * Determines how your purl.obolibrary.org/obo/immunotest/ redirects will be handled
     ...
     * Paste in the contents of [immunotest.yml](immunotest.yml)
 ...
 * [immunotest.md](immunotest.md)
     ...
     * Paste in the contents of [immunotest.md](immunotest.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
